...
export const WellnessIcon = ({
  ...
  return (
    <svg
      ...
      fill='none'
    >
      <rect width={width} height={height} fill='url(#pattern0_1402_11103)' />
      <defs>
        <pattern
          id='pattern0_1402_11103'
          patternContentUnits='objectBoundingBox'
          width='1'
          height='1'
        >
          <use xlinkHref='#image0_1402_11103' transform='scale(0.0078125)' />
        </pattern>

        {/* Filter to apply color overlay */}
        <filter id='colorOverlay' colorInterpolationFilters='sRGB'>
