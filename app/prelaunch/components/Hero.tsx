...
{/* Main Hero Section */}
    ...
    <div className={`${styles.barlow} content mt-[1.5rem] md:mt-[5rem] max-md:text-center `}>    
    <h1 className="text-[2rem] md:text-[2.875rem] font-[500]">Are you a <span className="font-[600] italic text-[3.75rem] md:text-[4.75rem]">Trip Organizer</span></h1>
    <h1 className="text-[2rem] md:text-[2.875rem] font-[500]">or a <span className="font-[600] italic text-[3.75rem] md:text-[4.75rem]">Trip Leader</span> </h1>    
    <h1 className="text-[2rem] md:text-[2.875rem] font-[500] pt-4">that organizes fixed departure group trips?</h1>

<div className={`${styles.poppins} md:w-[180%] text-[#575757] max-lg:mt-[5rem] lg:w-full z-1`}>

<h2 className="text-[1.5rem] md:text-[2rem] font-[500] py-4">We’ve got an offer you’ll love 🧡</h2>
...
<div className="max-lg:justify-center flex">
    ...
    <div className="image max-md:mt-[3.5rem] ">
    <Image src="/prelaunch-page-imgs/hero-1.jpg" alt="Hero Image in which a looking for destination" width={4000} height={2000} className=" z-[-1] md:absolute w-[95%]  md:w-[55%] lg:w-[45%] top-40 right-0"/>
    </div>
    </section>
...
{/* Intro Section */}
    <section className={`${styles.poppins} intro_section w-full grid grid-cols-1 md:grid-cols-2 gap-[5rem] mt-[5rem]`}>
        ...
        <Image src="/prelaunch-page-imgs/intro-hero.webp" alt="Image showing travellers having fun" width={2412} height={1996} className="w-[110%] md:w-full"/>
        </div>
        <div className="content max-md:text-center order-1 md:order-2">
            <h1 className={`${styles.poppins} text-[3.5rem] md:text-[4.5rem] font-[700] pb-5  `}>What is <span className={styles.grad_txt}> Ragir?</span></h1>
            <h2 className="text-[1.25rem] md:text-[1.75rem] text-[#333333] font-[600] italic pt-5">Ragir is India’s first search and discovery
