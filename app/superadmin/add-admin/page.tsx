        ...
        <main className="flex-1 p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center mb-8">
              <Link href="/superadmin" className="mr-4 p-2 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                {/* Admin ID */}
                <div>
                  <Label htmlFor="adminId" className="text-sm font-medium text-gray-900 mb-2 block">
                    Admin ID
                  </Label>
                  <Input
                    id="adminId"
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`placeholder:text-gray-400 ${emailError ? "border-red-500 focus:border-red-500" : ""}`}
              ...
              {/* Role Level */}
              <div className="mb-8">
                <Label className="text-sm font-medium text-gray-900 mb-2 block">Select Role Level</Label>
                <Select
                  value={formData.role}
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="super-admin">Super Admin (Full Platform Control)</SelectItem>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-700 leading-relaxed">
                      <span className="font-medium">Important:</span> The new admin will receive an email invitation
                      with their pre-filled email address and instructions to complete their registration and set up
                      their password.
                    </p>
                  </div>
                </div>
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(135deg, #FEA901 0%, #FD6E34 25%, #FE336A 75%, #FD401A 100%)",
                }}
              >
